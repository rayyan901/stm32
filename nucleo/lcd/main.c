...
char scan_keypad(void)
{
    ...
    GPIO_TypeDef* row_ports[] = {GPIOA, GPIOB, GPIOB, GPIOC};
    uint16_t row_pins[] = {GPIO_PIN_10, GPIO_PIN_14, GPIO_PIN_13, GPIO_PIN_4};
...
int main(void)
{
  ...
  mydata='K';
      ...
      lcd_gotoxy(&lcd1, 9, 1);
      lcd_putchar(&lcd1, mydata);
      //lcd_puts(&lcd1, "11 Jul 2025");
